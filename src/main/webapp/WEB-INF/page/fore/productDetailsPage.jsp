...
<head>
    ...
    <title>${requestScope.product.product_name}-ego.com易购</title>
</head>
<body>
<nav>
    ...
    <div class="header">
        ...
        <span class="shopNameHeader">月婵${requestScope.product.product_category.category_name}官方旗舰店</span>
        ...
        <div class="shopSearchHeader">
            <form action="${pageContext.request.contextPath}/product" method="get">
                <div class="shopSearchInput">
                    <input type="text" class="searchInput" name="product_name" placeholder="搜索 易购 商品/品牌/店铺"
                           maxlength="50">
                    <input type="submit" value="搜易购" class="searchTmall">
                </div>
    ...
    <div class="loginDiv">
        ...
        <div class="qrcodeLogin">
            ...
            <div class="qrcodeFooter">
                ...
                <p>打开 <a href="https://www.tmall.com/wow/portal/act/app-download">手机易购</a> | <a
...
<div class="context">
    ...
    <div class="context_info">
        ...
        <ul class="context_other_panel">
            ...
            <li class="tmall_points">送易购积分<span><fmt:formatNumber type="number"
